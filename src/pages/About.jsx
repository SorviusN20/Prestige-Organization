      ...
      <div className="testimonials-section">
        ...
        <div className="testimonials-grid">
          <blockquote className="testimonial-card">
            ...
            <cite className="testimonial-cite">— Larissa, Los Angeles</cite>
          </blockquote>
          <blockquote className="testimonial-card">
            ...
            <cite className="testimonial-cite">— Chris, Tarzana</cite>
          </blockquote>
          <blockquote className="testimonial-card">
            ...
            <cite className="testimonial-cite">— Jacob, LA</cite>
          </blockquote>
        </div>
      </div>
    </section>
